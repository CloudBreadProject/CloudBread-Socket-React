...
async function deploy() {
  ...
  const remote = {
    name: 'azure',
    url: 'https://beingbook@hbh-cloudbread-socket-client.scm.azurewebsites.net:443/hbh-cloudbread-socket-client.git',
    website: 'http://hbh-cloudbread-socket-client.azurewebsites.net',
  };
